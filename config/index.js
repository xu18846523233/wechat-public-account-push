export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxfef16d0e20c81971",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "3287adfb2c1828bf3ede7ec4e4848cc6",
   ...
   */
  USERS: [ososX6oCjlUBmzHZyMR0iRiHI3IE,ososX6grXjsC-njzFq5hvuV-LrfM
    {
      // 想要发送的人的名字
      name: "老婆0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "ososX6oCjlUBmzHZyMR0iRiHI3IE,ososX6grXjsC-njzFq5hvuV-LrfM",
      // 所在省份
      province: "黑龙江",
      // 所在城市
      city: "哈尔滨",
  ...
  CALLBACK_TEMPLATE_ID: "3R8nBcz_TvMzOSjA5fg9xQQd7g3CNdzoWaSXsJX9Cz4",
